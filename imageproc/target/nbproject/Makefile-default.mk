...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1126903162/delay.o ${OBJECTDIR}/_ext/1126903162/init_default.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/bootloader.o ${OBJECTDIR}/source/radio_polling.o ${OBJECTDIR}/source/progmem.o ${OBJECTDIR}/source/memory.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1126903162/delay.o.d ${OBJECTDIR}/_ext/1126903162/init_default.o.d ${OBJECTDIR}/source/main.o.d ${OBJECTDIR}/source/bootloader.o.d ${OBJECTDIR}/source/radio_polling.o.d ${OBJECTDIR}/source/progmem.o.d ${OBJECTDIR}/source/memory.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1126903162/delay.o ${OBJECTDIR}/_ext/1126903162/init_default.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/bootloader.o ${OBJECTDIR}/source/radio_polling.o ${OBJECTDIR}/source/progmem.o ${OBJECTDIR}/source/memory.o
